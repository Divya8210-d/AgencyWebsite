  ...
  return (
    <div className="relative z-50">
      ...
      <div className="text-white w-full px-4 sm:px-6 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] w-full gap-6 py-10">
          ...
          <div className="space-y-2 leading-[1.1] text-center lg:text-left">
            <div className="text-[64px] sm:text-[72px] md:text-[96px] font-extrabold">
            ...
            <div className="text-[64px] sm:text-[72px] md:text-[96px] font-extrabold">
              WHAT <span className="text-[#00AEEF]">YOUR BRAND</span> TRULY
              NEEDS.
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center lg:justify-end items-center lg:items-end gap-3 mb-2">
            <p className="text-base tracking-widest text-center lg:text-right font-poppins">
              EXPLORE OUR
              <br />
              DIVERSE RANGE
              <br />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-8 px-6 lg:px-24">
        <div className="relative bg-gray-800 rounded-xl h-64 overflow-hidden text-white">
          {/* Background Image */}
          <img
            src="/cardbg.png"
            alt="card background"
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
            ...
            <p className="text-base sm:text-lg text-gray-200 mt-2 max-w-xs font-poppins">
        ...
        <div className="flex flex-col gap-16 order-1 lg:order-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto] items-start text-center sm:text-left">
            <div className="leading-[1.1] space-y-1">
              <div className="text-[64px] sm:text-[96px] font-extrabold">
            ...
            <div className="hidden lg:flex flex-col justify-end items-center sm:items-end gap-3 mt-6 sm:mt-2">
              <p className="text-[18px] tracking-widest text-center sm:text-right font-poppins">
                EXPLORE OUR <br />
                DIVERSE RANGE <br />
                OF SERVICES
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-black/30 border border-white/20 rounded-2xl p-6">
              ...
              <p className="text-base mt-2 opacity-80 font-poppins">
                For individuals looking to build a strong online identity,
                showcase their work with clarity, and create a digital presence
                that feels authentic and professional.
              </p>
            </div>

            <div className="bg-[#1d2b36] rounded-2xl p-6">
              <div className="text-[32px] font-bold text-[#00AEEF]">
                02{" "}
                <span className="font-semibold mt-2 text-white">
                  Small & Growing Businesses
                </span>
              </div>

              <p className="text-base mt-2 opacity-80 font-poppins">
                For teams that need a modern website, clearer messaging, and a
                digital presence that supports sales, trust, and long-term
                growth.
              </p>
            </div>
            ...
            <div className="border border-white/30 rounded-2xl p-6">
              ...
              <p className="text-base mt-2 opacity-80 font-poppins">
                For early-stage companies preparing to launch or scale, who need
                fast, smart web solutions that communicate their vision and
                build credibility.
              </p>
            </div>
            ...
            <div className="bg-black/30 border border-white/20 rounded-2xl p-6">
              ...
              <p className="text-base mt-2 opacity-80 font-poppins">
                For businesses seeking a fresh digital upgrade—flexible,
                scalable, and reliable solutions without unnecessary complexity.
              </p>
            </div>
          </div>
        </div>
